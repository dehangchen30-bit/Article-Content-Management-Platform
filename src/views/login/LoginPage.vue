...
<template>
  <el-row class="login-page">
    ...
    <el-col :span="18" :offset="3" class="form">
      ...
      <!-- 登录 -->
      <el-form :model="formModel" :rules="loginRules" ref="form" size="large" autocomplete="off" v-else>
        <el-form-item>
          <h1>登录</h1>
        </el-form-item>
        <el-form-item prop="username">
        ...
        <el-form-item>
          <el-button @click="loginFn" class="button" type="primary" auto-insert-space
            >登录</el-button
          >
        </el-form-item>
        <el-form-item class="flex">
